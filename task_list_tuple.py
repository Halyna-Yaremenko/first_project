...
# count = 0     # скільки чисел уже виведено
# number = 1    # поточне число
...
# # Зчитуємо три числа a, b, c з одного рядка і перетворюємо їх у цілі числа
# a, b, c = map(int, input("Enter a, b, c: ").split())

# # Створюємо порожній список, у який будемо додавати "шари"
# array_3d = []

# # Зовнішній цикл: створює 'a' шарів (наприклад, 2 шари)
# for i in range(a):
#     # Кожен шар — це список, який містить 'b' рядків
#     layer = []
    
#     # Середній цикл: створює 'b' рядків у кожному шарі
#     for j in range(b):
#         # Кожен рядок — це список із 'c' нулів
#         row = []
        
#         # Внутрішній цикл: додає 'c' нулів у кожен рядок
#         for k in range(c):
#             row.append(0)
        
#         # Додаємо цей рядок до поточного шару
#         layer.append(row)
    
#     # Додаємо сформований шар до 3D масиву
